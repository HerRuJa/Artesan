    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                <h3 class="box-litle">Cliente: </h3><br />
                <h3 class="box-litle"><?= $data_venta->clientes->name.' '.$data_venta->clientes->ap_pat
                .' '.$data_venta->clientes->ap_mat ?><br />
                &nbsp; RFC: RJH000426KL1</h3><br />
                <h3 class="box-litle"><?= 
                $data_venta->clientes->direccion.' Colonia '.
                $data_venta->clientes->colonia.' CP '.
                $data_venta->clientes->cp.', '.
                $data_venta->clientes->municipios->nombre.' Edo. de '.
                $data_venta->clientes->entidades->nombre.', '.
                $data_venta->clientes->paises->nombre;
                
                ?> </h3><br />
                <h3 class="box-litle">Fecha de venta - <?= $data_venta->fecha; ?></h3> <br />
            </div>
            <div class="box-body">

...
<div class="container cont">
    ...
    {!! Form::open([ 'method' => 'PATCH' , 'url'=>'/municipios/'.$municipio->id]) !!}
        ...
        {!! Form::select ('id_pais', $pais->pluck('nombre','id')->all(), $municipio->entidades->id_pais, ['class'=>
        ...
        {!! Form::select ('id_entidad', $entidad->pluck('nombre','id')->all() , $municipio->id_entidad ,['class'=>
        ...
        {!! Form::select ('status', 
        array('1'=>'Activo','0'=>'Baja') , $municipio->status ,['class'=>
        'form-control','placeholder'=>'Seleccionar ...']) !!}
        <br />
        <br />
        {!! Form::submit('Guardar Municipio',['class'=>'btn btn-outline-dark']) !!}
        {!! Form::close() !!}
        </div>
        <x-layouts.footer/>
</body>

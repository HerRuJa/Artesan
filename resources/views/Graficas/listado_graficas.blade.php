            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-examples">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Ver productos en existencia</td>
                            <td>
                                <a href="{!! asset('grafica_areas') !!}" target="_blank">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! asset('grafica_barras') !!}" target="_blank">
                                    <button class="btn btn-block btn-outline-dark btn-xs">Ver</button></a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{!! asset('grafica_mes') !!}" target="_blank">
                                    <button class="btn btn-block btn-outline-dark btn-xs">Ver</button></a>
                            </td> 
                        </tr>
                    </tbody>
